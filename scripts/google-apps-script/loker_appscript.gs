...
const SHEET_ID = "1lYPRqP9tKauCQAu8n7a3t51X_4I5qWfouR-lfBtVio8";

// 2. Get your Folder ID from its URL in Google Drive:
//    https://drive.google.com/drive/folders/THIS_IS_THE_ID
const FOLDER_ID = "1rpA5KuzjG7lcbb2859oVPQt15t5sS7Ui";
...
function doPost(e) {
    try {
        ...
        //    The order must match your new columns: nama, email, nomor, source, alamat, posisi, cv, file
        sheet.appendRow([
            data.nama,
            data.email,
            data.nomor,
            ...
            data.posisi || '',  // Add the posisi field (category: Design, Admin, Produksi, Reseller)
