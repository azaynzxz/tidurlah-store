    ...
    <div class="space-y-6">
      ...
      <div class="space-y-4">
        <details class="bg-gray-50 p-4 rounded-lg">
          <summary class="font-semibold text-gray-900 cursor-pointer hover:text-[#FF5E01]">Barang yang dapat dikembalikan</summary>
          <div class="mt-4">
        ...
        <details class="bg-gray-50 p-4 rounded-lg">
          <summary class="font-semibold text-gray-900 cursor-pointer hover:text-[#FF5E01]">Barang yang tidak dapat dikembalikan</summary>
          <div class="mt-4">
            <ul class="list-disc list-inside space-y-1 text-gray-700">
        ...
        <details class="bg-gray-50 p-4 rounded-lg">
          <summary class="font-semibold text-gray-900 cursor-pointer hover:text-[#FF5E01]">Syarat dan ketentuan pengembalian barang</summary>
          <div class="mt-4">
            <ul class="list-disc list-inside space-y-1 text-gray-700">
        ...
        <details class="bg-gray-50 p-4 rounded-lg">
          <summary class="font-semibold text-gray-900 cursor-pointer hover:text-[#FF5E01]">Proses pengembalian barang</summary>
          <div class="mt-4">
            <ul class="list-disc list-inside space-y-1 text-gray-700">
        ...
        <details class="bg-gray-50 p-4 rounded-lg">
          <summary class="font-semibold text-gray-900 cursor-pointer hover:text-[#FF5E01]">Kebijakan pengembalian dana</summary>
          <div class="mt-4">
            <ul class="list-disc list-inside space-y-1 text-gray-700">
        ...
        <details class="bg-gray-50 p-4 rounded-lg">
          <summary class="font-semibold text-gray-900 cursor-pointer hover:text-[#FF5E01]">Perlindungan data pribadi</summary>
          <div class="mt-4">
            <ul class="list-disc list-inside space-y-1 text-gray-700">
      ...
      <div class="bg-[#FF5E01]/10 p-6 rounded-lg border border-[#FF5E01]/20">
        <h3 class="text-lg font-semibold text-gray-900 mb-2">Proses Mudah dan Cepat untuk Kebutuhan Cetak Anda</h3>
        <p class="text-gray-700">Kami berkomitmen memberikan layanan terbaik dengan proses pengembalian yang transparan dan mudah diikuti.</p>
      </div>
    </div>
  `,
  relatedProducts: []
